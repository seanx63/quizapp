    ...
    <Header/>
        <div class="container h-100 login_form">
            <div class="row h-100 align-items-center">
              ...
              {createAccount ? <h1>Create your account</h1> : <h1>Log in to your account</h1>}
                {createAccount ? <SignUp/> : <SignIn/>}
                {createAccount ? 
                    <div>
                        <p>Do not have an account?</p><button class="btn btn-success" onClick={()=>changeCreateAccount()}>Create one!</button>
                    </div> : 
                    <div>
